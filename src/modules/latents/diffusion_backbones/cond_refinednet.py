...
class ConditionalInstanceNorm2dPlus(nn.Module):
    def __init__(self, num_features, num_classes, bias=True):
        ...
        if bias:
            ...
            self.embed.weight.data[:, : 2 * num_features].normal_(1, 0.02)  # N(1, 0.02)
            self.embed.weight.data[:, 2 * num_features :].zero_()  # bias at 0
        else:
